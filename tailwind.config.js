...
module.exports = {
  ...
  theme: {
    ...
    colors: {
        ...
        // 'primary-blue': '#2B44E7',
        // 'secondary-blue': '#2A3342',
        // 'primary-gray': '#556987',
        // 'secondary-gray': '#E3E6FB',
        'light-gray': '#ECEDED',
        'dark-gray': '#4F4F4F',
        'middle-gray': '#5C5D5C',
        'primary-blue': '#8CA4D3',
    ...
    backgroundImage: {
        'header': "url('/images/background/background-header.png')",
        'header-1': "url('/images/background/bg-home-2.png')",
        'body-white': "url('/images/background/background-body-white.png')",
        'body-1': "url('/images/background/background-body.png')",
        'quantity': "url('/images/background/background-quantity.png')",
    ...
    fontFamily: {
        ...
        martel: ['Martel', 'DM Serif Display'],
